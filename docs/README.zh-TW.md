...
> Postgres,見 [docs/pg-migration.zh-TW.md](pg-migration.zh-TW.md)。
...
[docs/ARCHITECTURE.zh-TW.md](ARCHITECTURE.zh-TW.md)。

## 文件

- [docs/ARCHITECTURE.zh-TW.md](ARCHITECTURE.zh-TW.md) — 架構、pipeline、HA(含圖)
- [apiv1.zh-TW.md](apiv1.zh-TW.md) — admin REST API
- [`proto/gua.proto`](../proto/gua.proto) — gRPC `GuaAdmin` + `GuaCallback`
- [docs/MONITORING.zh-TW.md](MONITORING.zh-TW.md) — `/v1/status`、`/v1/{group}/history`、`/ui`、logging
